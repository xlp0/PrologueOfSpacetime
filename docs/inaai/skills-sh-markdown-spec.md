---
concept: skills-sh-markdown-spec
tags: [skills, claude-code, anthropic, markdown, yaml, agentskills, spec]
source: YouTube — Claude Code Skills & skills.sh - Crash Course (https://www.youtube.com/watch?v=rcRS8-7OgBo) and YouTube — I Turned Claude Into the Ultimate Second Brain (https://m.youtube.com/watch?v=8QQ_INxAhRs)
date: 2026-06-26
---
