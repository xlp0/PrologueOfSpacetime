...
> **Scenario**: The Cloud has collapsed. The world has gone silent. You are the last surviving node, tasked with rebuilding the "Universal Brain" (The Grid).

## Phase 1: The Firefall (Arithmetic & Rhetoric) — "Counting What Remains"
*Theme: Survival, Inventory, Value Definition.*
...
| **Ch 4** | **Astronomy** | **Rhetoric (Why)** | **The Observation**: You look up. The Firefall is not one probe; it's 65,536. You realize the scale of the invasion. You are small. You need a system. | **Observation**: Telescopes, data logging. Documenting the macro-scale. Building the **SSOT**. |

## Phase 2: Theseus (Logic & Implementation) — "Building the Ship"
*Theme: Construction, Engineering, Systems.*

| Chapter | Subject | Focus (Trivium) | Narrative (Back Story) | Lesson Focus (Skill) |
| :--- | :--- | :--- | :--- | :--- |
| **Ch 5** | **Arithmetic** | **Logic (How)** | **Allocation**: You have 1000 units of energy and 50 mouths to feed. How do you distribute it? The Vampire Captain (Logic) takes command. Ruthless efficiency. | **Allocation Algorithms**: Resource distribution logic. Queues, Stacks, Priority. (The Vampire's Math). |
| **Ch 6** | **Geometry** | **Logic (How)** | **Pathfinding**: You must travel to the crash site. The terrain is hostile. You need a map. You deploy the **Sovereign Drone**. | **Pathfinding**: A* Algorithm, Vector Navigation. 3D Printing the drone chassis (Manufacturing). |
| **Ch 7** | **Music** | **Logic (How)** | **Causality**: You send a signal; does it return? You build a radar. Action → Reaction. The "Feedback Loop" of the machine. | **Causality & Loops**: Input/Output logic. The Oscilloscope (Seeing the signal return). |
| **Ch 8** | **Astronomy** | **Logic (How)** | **Prediction**: The probes are moving. Where will they be in 24 hours? You must calculate the orbit. You become the Oracle. | **Prediction**: Orbital mechanics, linear regression. Forecasting the future state. |

## Phase 3: Rorschach (Grammar & Verification) — "The Confrontation"
*Theme: Verification, Truth, Consensus.*
...
*   **Ch 5-8 (How)**: **Oscilloscope**, **3D Printer**, **Drone**, **Telescope**. (The Engineer/Biologist).
*   **Ch 9-12 (What)**: **Servers**, **Code**, **Consensus Algorithms**. (The System/Vampire).
