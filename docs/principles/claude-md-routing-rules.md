---
title: 'claude-md-routing-rules'
date: 2026-06-28
tags: [Trivium-Grammar, Seven-Liberal-Arts, claude-code, claude-md, routing, codex, tool-agnostic]
type: principle
sources: [YouTube — Every Level of a Claude Second Brain Explained (https://youtu.be/DTCyvo6cC54); also confirmed in "The Next Era of Second Brains Is Here" (https://www.youtube.com/watch?v=xHAZo1SmnhM)]
status: stable
