---
title: 'Chapter 4 — Tokens and Context'
date: 2026-06-25
tags: [Teaching, AI-Coding-Guide, Seven-Liberal-Arts, Quadrivium-Arithmetic]
type: note
sources: []
status: stable
...
This is the entire subject of Chapter 6 ([[static-vs-dynamic-context|context engineering]]), so we won't dwell here. The takeaway is that **the context window is not just a size — it's a budget that has to be managed.** A good harness manages it well; a bad one manages it badly; and you, by writing good rules files and giving good instructions, influence what's worth keeping.
