...
**MCP** (Model Context Protocol) is an open standard, introduced by Anthropic in late 2024 and adopted widely since, that lets an AI harness talk to external tools and data sources in a uniform way. The standard nickname is "the USB-C of AI" — one plug shape, many devices.
