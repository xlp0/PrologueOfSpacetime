...
- **Claude Code** — Anthropic's terminal agent, tightly integrated with Claude models. Reads `CLAUDE.md` (project, user, and enterprise tiers). Supports slash commands, custom commands, MCP servers, and skills. Has become a default reference point for "what a good terminal agent feels like."
...
The point of mentioning these: **"AI coding" is the leading edge of a broader pattern.** The same stack — model, harness, context engineering, MCP, skills, workflows — is showing up everywhere. Learn it once here, and you've learned it for the rest.
