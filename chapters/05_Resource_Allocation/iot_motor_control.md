...
*   **Application**: The [Solar RC Toy Car](../../docs/shopper_analytics/build_toy_car.md) is a practical application of this. A dynamo (DC motor) is mounted to a 3D-printed chassis, wired to solar panels, and driven to actuate a 10-tooth to 23-tooth gear assembly.
