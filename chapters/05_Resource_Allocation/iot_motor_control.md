...
In **Chapter 02**, we built the Form (Geometry). Now, in **Chapter 05**, we must allocate **Resource** (Energy) to create **Motion**.
*   **The Monad**: The Token (Energy Unit).
*   **The Actuator**: The Motor (Energy Consumer).
