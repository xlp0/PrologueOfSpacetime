...
graph TD
    ...
    subgraph "The Dimensions"
        GEO["**Geometry**<br/>Number in Space<br/>(Static Structure)"]
        MUS["**Music**<br/>Number in Time<br/>(Dynamic Rhythm)"]
    end

    subgraph "The Synthesis: Spacetime & Life"
        AST["**Astronomy / Astrobiology**<br/>Number in Spacetime<br/>(Evolution & Orbit)"]
    end

    AR -->|"Extends to Space"| GEO
    AR -->|"Extends to Time"| MUS
    GEO -->|"Composes"| AST
    MUS -->|"Composes"| AST

    style AR fill:#fff3e0,stroke:#ef6c00
    style GEO fill:#e3f2fd,stroke:#1565c0
    style MUS fill:#f3e5f5,stroke:#7b1fa2
